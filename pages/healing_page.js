		...
		<div className="flex relative w-full md:h-96 overflow-hidden">
			<div className="z-0 w-full">
				<div className="hidden md:flex">
					<Image priority	src="/images/top/healer.jpg" layout="fill" objectFit="cover" />
				</div>
				<div className="flex md:hidden">
					<Image priority	src="/images/top/healer.jpg" width="4000" height="2666" />
				</div>
			</div>
			<div className="z-10 flex flex-col items-center absolute w-full">
				...
				<div className="flex md:hidden items-center pt-8 md:pt-20 text-sm md:text-lg text-white font-bold">
					<LinkItem href="" title="Holistic Healing" selected />
				</div>
				<div className="md:flex hidden items-center pt-8 md:pt-20 text-sm md:text-lg text-white font-bold">
					...
					<LinkItem href="healing_page" title="Holistic Healing" selected />
...
function TopBar() {
	return (
		<div className="flex relative w-full md:h-96 mt-16 overflow-hidden">
			<div className="z-0 w-full">
				<div className="hidden md:flex">
					<Image priority	src="/images/top/healer_bottom.jpg" layout="fill" objectFit="cover" />
				</div>
				<div className="flex md:hidden">
					<Image priority	src="/images/top/healer_bottom.jpg" width="8000" height="5500" />
