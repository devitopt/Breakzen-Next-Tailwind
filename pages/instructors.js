...
export default function Instructors() {
	const [users, setUsers] = useState([[{name: "JOHN CARTER", id: 1}, {id: 2}, {name: "JOHN CARTER", id: 3}, {id: 4}, {id: 7}],
																			[{id: 3}, {id: 1}, {id: 2}, {id: 5}, {id: 7}],
																			[{id: 6}, {name: "JOHN CARTER", id: 2}, {id: 3}, {id: 4}, {id:7}],
																			[{id: 4}, {name: "JOHN CARTER", id: 1}, {id: 3}, {id: 2}, { id: 7}],]);
    ...
    <Layout>
      <Head>
        <title>Instructors</title>
			...
			<MainHeader src="/images/instructor.png" title="INSTRUCTORS" comment="Find your next professional" />
			
			<div className="flex flex-wrap px-4 md:px-40 py-4 md:mt-12 md:mb-8">
				{users.map((rows, index) => (
					<div className="flex flex-col">
						<p className="text-white text-3xl font-bold px-4 py-8">
							{instructors[index]}
						</p>
