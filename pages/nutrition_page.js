		...
		<div className="flex relative w-full md:h-96 overflow-hidden">
			<div className="z-0 w-full">
				<div className="hidden md:flex">
					<Image priority	src="/images/top/nutrition.jpg" layout="fill" objectFit="cover" />
				</div>
				<div className="flex md:hidden">
					<Image priority	src="/images/top/nutrition.jpg" width="4800" height="3500" />
			...
			<div className="z-10 flex flex-col items-center absolute w-full">
				<div className="px-9 pt-16 md:pt-28 text-center text-white">
					<p className="text-xl md:text-5xl font-black">
						ENERGIZE YOUR NUTRITION PRACTICE
					</p>
...
function TopBar() {
	return (
		<div className="flex relative w-full md:h-96 mt-16 overflow-hidden">
			<div className="z-0 w-full">
				<div className="hidden md:flex">
					<Image priority	src="/images/top/nutrition_bottom.jpg" layout="fill" objectFit="cover" />
				</div>
				<div className="flex md:hidden">
					<Image priority	src="/images/top/nutrition_bottom.jpg" width="5800" height="3800" />
					<div className="absolute w-full h-full bg-black bg-opacity-30" />
				</div>
