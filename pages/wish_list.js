...
export default function Your_Cources() {
  return (
    <Layout>
      ...
      <MainHeader_Train nobutton src="/images/yoga.png"	width="1656" height="1112" title="YOUR WISHLIST" comment="Lorem ipsum dolor sit amet, consectetur adipiscing elit." />
